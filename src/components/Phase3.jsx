...
import { ArrowLeft, GraduationCap, CheckCircle, RefreshCcw, Sparkles } from 'lucide-react';
import confetti from 'canvas-confetti';
import { playClickSound } from '../utils/audio';

export default function Phase3({ data, onBack, onRestart }) {
  useEffect(() => {
    // Kích hoạt pháo bông (Confetti) khi render
    const duration = 3000;
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center mb-8 relative z-10">
        <button onClick={handleBack} className="btn btn-ghost btn-circle text-base-content/70 hover:text-primary">
